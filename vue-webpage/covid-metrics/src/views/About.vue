<template>
  <div class="about">
      ...
      <p>
        ...
        continue using the following technologies and to write my code in a way that it could be easily re-used. Below is a 
        list of the technologies used to create this project.
      </p>
